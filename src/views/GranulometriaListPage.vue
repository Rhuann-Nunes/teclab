    ...
    <div class="row items-center q-mb-md">
      <div class="col">
        <div class="row items-center">
          ...
          />
          <div>
            <h5 class="q-my-none">Ensaios de Granulometria</h5>
      ...
      <div>
        <q-btn
          ...
          icon="add"
          round
          :to="'/ensaios/terraplenagem/compactacao-aterro/ensaios-prod/granulometria/novo?ambiente=' + route.query.ambiente"
        >
                ...
                <div class="row items-center">
                  <div class="col">
                    ...
                    <div class="text-caption text-grey-7">
                      ...
                      % Passante: {{ formatNumber(ensaio.resultado[0]?.percentagem_retida_fundo) }}% |
                      % Retido Total: {{ formatNumber(ensaio.resultado[0]?.percentagem_acumulada_retida_0_075mm) }}%
                    </div>
                  </div>
                  <div class="col-auto">
                    <q-btn
...
const loadEnsaios = async () => {
  try {
      ...
      .select(`
        *,
        resultado:granulometria_resultados!id(
          percentagem_retida_fundo,
          percentagem_acumulada_retida_0_075mm
        )
      `)
    ...
    $q.notify({
      type: 'negative',
      message: 'Erro ao carregar ensaios'
    })
  }
}

const visualizarEnsaio = (ensaioId) => {
  router.push(`/ensaios/terraplenagem/compactacao-aterro/ensaios-prod/granulometria/visualizar/${ensaioId}?ambiente=${route.query.ambiente}`)
}
