    ...
    <div class="row items-center q-mb-md">
      <div class="col">
        <div class="row items-center">
          ...
          />
          <div>
            <h5 class="q-my-none">Ensaios de CBR e Expansão</h5>
      ...
      <div>
        <q-btn
          ...
          icon="add"
          round
          :to="'/ensaios/terraplenagem/compactacao-aterro/ensaios-prod/cbr/novo?ambiente=' + route.query.ambiente"
        >
          ...
          >
            ...
            <q-item-section>
              <q-item-label>
                <div class="row items-center">
                  <div class="col">
                    <div class="text-weight-medium">{{ ensaio.compactacao.nome_amostra }}</div>
                    <div class="text-caption text-grey-7">
                      Data: {{ formatDate(ensaio.data_ensaio) }} | 
                      I.S.C.: {{ formatNumber(ensaio.resultados[0]?.isc_escolhido) }}% |
                      Expansão: {{ formatNumber(ensaio.resultados[0]?.expansao_percentual) }}%
                    </div>
                  </div>
                  <div class="col-auto">
                    <q-btn
...
const visualizarEnsaio = (ensaioId) => {
  router.push(`/ensaios/terraplenagem/compactacao-aterro/ensaios-prod/cbr/visualizar/${ensaioId}?ambiente=${route.query.ambiente}`)
}
