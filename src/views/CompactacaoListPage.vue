    ...
    <div class="row items-center q-mb-md">
      <div class="col">
        <div class="row items-center">
          ...
          />
          <div>
            <h5 class="q-my-none">Ensaios de Compactação</h5>
      ...
      <div>
        <q-btn
          ...
          icon="add"
          round
          :to="'/ensaios/terraplenagem/compactacao-aterro/ensaios-prod/compactacao/novo?ambiente=' + route.query.ambiente"
        >
                ...
                <div class="row items-center">
                  <div class="col">
                    ...
                    <div class="text-caption text-grey-7">
                      ...
                      Densidade Máxima: {{ formatNumber(ensaio.resultado[0]?.massa_especifica_aparente_seca_maxima) }} g/cm³ |
                      Umidade Ótima: {{ formatNumber(ensaio.resultado[0]?.umidade_otima) }}%
                    </div>
                  </div>
                  <div class="col-auto">
                    <q-btn
...
const loadEnsaios = async () => {
  try {
    const { data, error } = await supabase
      ...
      .select(`
        *,
        resultado:compactacao_resultados_finais!compactacao_id(
          umidade_otima,
...
const visualizarEnsaio = (ensaioId) => {
  router.push(`/ensaios/terraplenagem/compactacao-aterro/ensaios-prod/compactacao/visualizar/${ensaioId}?ambiente=${route.query.ambiente}`)
}
